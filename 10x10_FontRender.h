...
// Fixed P: simpler, balanced bowl (top only),
// stem full height
...
// Fixed 0: a little narrower than letter O
// (margin 1..9)
...
// Fixed 1: clear vertical stroke + top hook +
// bottom foot
...
// _8: kept symmetrical double-loop, still
// readable
...
static LineSegment _excl[] = {
    {4, 8, 5, 8},
    {4, 7, 5, 7}, // Main vertical (with cap)
    {4, 5, 4, 0},
    {4, 0, 4, 3}, // Square dot
    {5, 0, 5, 3}  // Square dot
};
